...
root=Path('/home/data/wangxuran/tncn_event_read_20260909')
...
for name,base in [('previous_profile.json',profile),('previous_diagnosis.json',diagnosis),('previous_csr.json',csr),('previous_memory.json',memory),('previous_nograd.json',nograd),('previous_oracle.json',oracle)]:
