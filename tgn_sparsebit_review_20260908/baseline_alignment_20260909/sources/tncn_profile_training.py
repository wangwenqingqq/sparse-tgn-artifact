...
class Trainer:
    def __init__(self, name, bs):
        ...
        self.model.train()
        # Source train() resets after moving to device; message-store dictionaries
        # are not registered buffers and .to(device) alone does not move them.
...
def main():
    ...
    # All logical data are initialized explicitly; preserve normal allocation cost.
