...
root=Path('/home/data/wangxuran/tncn_state_nograd_20260909')
...
for name,base in [('previous_profile.json',profile),('previous_diagnosis.json',diagnosis),('previous_csr.json',csr),('previous_memory.json',memory)]:
